...
- **artifacts** (optional, array of [`Artifact`](#418-artifact)): A set of output artifacts for a Task.
...
**Response:** See [`PushNotificationConfig`](#431-taskpushnotificationconfig) object definition.
